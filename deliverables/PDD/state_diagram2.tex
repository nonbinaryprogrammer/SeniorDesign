...
\draw (40.5,-32.1) node [below] {$10$};
\draw [black] (33.123,-38.38) arc (54:-234:2.25);
\draw (31.8,-42.95) node [below] {$9$};
...
\draw (31.1,-24.87) node [above] {$8$};
\draw [black] (18.955,-28.006) arc (76.78951:48.35301:24.61);
\fill [black] (18.96,-28.01) -- (19.62,-28.68) -- (19.85,-27.7);
\draw (25.66,-29.62) node [above] {$7$};
\end{tikzpicture}
\end{center}
